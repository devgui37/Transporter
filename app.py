...
def total_cout(chemin: str = typer.Option(
        None, "--chemin", prompt="Entrez le chemin du fichier de données", help="Chemin du fichier de travail"
    )):
...
def total_quantite(chemin: str = typer.Option(
        None, "--chemin", prompt="Entrez le chemin du fichier de données", help="Chemin du fichier de travail"
    )):
...
def resultat_client(chemin: str = typer.Option(
        None, "--chemin", prompt="Entrez le chemin du fichier de données", help="Chemin du fichier de travail"
    )):
...
def resultat_entrepot(chemin: str = typer.Option(
        None, "--chemin", prompt="Entrez le chemin du fichier de données", help="Chemin du fichier de travail"
    )):
...
def representation(chemin: str = typer.Option(
        None, "--chemin", prompt="Entrez le chemin du fichier de données", help="Chemin du fichier de travail"
    )):
...
def representation_client(chemin: str = typer.Option(
        None, "--chemin", prompt="Entrez le chemin du fichier de données", help="Chemin du fichier de travail"
    ),
    client: str = typer.Option(
    None, "--client", prompt="Numéro du client", help="Choix du client à visualiser." 
    )):
...
def representation_entrepot(
    ...
    None, "--entrepot", prompt="Numéro de l'entrepot", help="Choix de l'entrepôt à visualiser."
    )):
